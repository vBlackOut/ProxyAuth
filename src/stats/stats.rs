...
mod tests {
    use super::*;
    use actix_web::{test, http::header, HttpResponse, Responder};
    use std::sync::Arc;
    use dashmap::DashMap;
    ...
    type RoutesWrapper = crate::config::config::RouteConfig;
    ...
    fn make_state(stats_enabled: bool) -> web::Data<AppState> {
        ...
        let counter = Arc::new(crate::stats::tokencount::CounterToken::new());
