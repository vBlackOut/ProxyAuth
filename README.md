...
It generates an encrypted token using ChaCha20 and HMAC-SHA-256, based on a secret from its config. This ensures secure, external access without exposing internal logic.
